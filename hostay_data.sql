...
INSERT INTO `tblcontact` (`contact_id`,`contact_fullname`,`contact_email`,`contact_subject`,`contact_notes`,`contact_seen`,`contact_created_at`) VALUES 
 (1,'Nguyễn Quang Huy','nguyenquanghuylt2002@gmail.com','Về dịch vụ','Dịch vụ đáp úng chưa tốt lắm, mong cải thiện thêm',1,'2024-5-16 00:00:00'),
 (2,'Hotel HaiPhong Avant','haiphonghotelwie@gmail.com','Hợp tác','Chúng tôi muốn cơ hội hợp tác với dịch vụ của Hostay',0,'2024-5-22 00:00:00'),
 (3,'Phạm Tiến Công','congtien@gmail.com','dịch vụ tốt','...',1,'2024-01-23 00:00:00'),
...
INSERT INTO `tblservices` (`service_name`, `service_description`, `service_price`, `service_created_at`) VALUES
('Dọn Phòng', 'Dịch vụ dọn phòng hàng ngày', 100000, NOW()),
('Giặt Là', 'Dịch vụ giặt và là ủi', 150000, NOW()),
('Đón Sân Bay', 'Dịch vụ đón từ sân bay', 250000, NOW());
